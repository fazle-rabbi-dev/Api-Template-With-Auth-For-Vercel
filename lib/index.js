...
// check
export const generateEmailChangeRequestNotificationEmail = (userName, link) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            <h2>Hello ${userName},</h2>
            <p>We received a request to change the email associated with your ${PROJECT_NAME} account.</p>
            <a href="${link}" class="btn">Confirm Email Change</a>
