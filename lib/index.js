...
export const ACCOUNT_CONFIRMATION_ROUTE = "http://localhost:3000/api/users/confirm-account";
export const EMAIL_CHANGE_CONFIRMATION_ROUTE = "http://localhost:3000/api/users/confirm-change-email";
export const RESET_PASSWORD_ROUTE = "http://localhost:3000/api/users/reset-password";
export const ALLOWED_CORS_ORIGIN = [process.env.CORS_ORIGIN1, process.env.CORS_ORIGIN2];
...
/* Notification Emails */
export const generateNewLoginNotificationEmail = (userName, loginTime, device) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            <h2>Hello ${userName},</h2>
            <p>We noticed a new login to your ${PROJECT_NAME} account on ${loginTime} from ${device}.</p>
            <p>If this was you, no further action is needed. If you don't recognize this, please reset your password immediately.</p>
            <p>Regards,<br>${DEVELOPER_NAME}</p>
        </div>
    </body>
    </html>
...
export const generatePasswordChangeNotificationEmail = userName => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            <h2>Hello ${userName},</h2>
            <p>Your ${PROJECT_NAME} account password has been successfully changed.</p>
...
export const generateEmailChangedNotificationEmail = userName => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            <h2>Hello ${userName},</h2>
            <p>Your email address associated with your ${PROJECT_NAME} account has been successfully changed.</p>
            <p>If you didn't request this change, please contact us at [${DEVELOPER_EMAIL}] immediately.</p>
            <p>Regards,<br>${DEVELOPER_NAME}</p>
        </div>
    </body>
    </html>
